          ...
          <div class="content-grid">
            ...
            <aside class="miner-panel">
              <div class="sun-zone">
                ...
                ${o?I`<img class="overheat-image" src=${l} alt="Overheat warning" />`:q}
              </div>
              ...
              <div class="stat-stack">
                ...
                <article class="stat-row">
                  ...
                  <span class="value">${i.value||"Unavailable"}</span>
                </article>
                <article class="stat-row">
                  <span class="label">Temp</span>
                  <span class=${h}>${e.value}${e.unit}</span>
                </article>
                <article class="stat-row">
                  <span class="label">Power</span>
                  <span class="value accent-cyan">${s.value} ${s.unit}</span>
                </article>
              </div>

              ${o?I`<div class="warning-chip">Overheat active (${r}${e.unit||"°C"})</div>`:q}
            </aside>
          </div>
        </section>
      </ha-card>

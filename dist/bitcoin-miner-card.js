 ...
 */
const e=globalThis,s=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),n=new WeakMap;let r=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(s&&void 0===t){const s=void 0!==e&&1===e.length;s&&(t=n.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&n.set(e,t))}return t}toString(){return this.cssText}};const o=t=>new r("string"==typeof t?t:t+"",void 0,i),a=s?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return o(e)})(t):t,{is:l,defineProperty:h,getOwnPropertyDescriptor:c,getOwnPropertyNames:d,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,f=globalThis,m=f.trustedTypes,$=m?m.emptyScript:"",_=f.reactiveElementPolyfillSupport,y=(t,e)=>t,v={toAttribute(t,e){switch(e){case Boolean:t=t?$:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},g=(t,e)=>!l(t,e),b={attribute:!0,type:String,converter:v,reflect:!1,useDefault:!1,hasChanged:g};
/**
 * @license
 ...
 */function dt(t){return(e,s)=>"object"==typeof s?ct(t,e,s):((t,e,s)=>{const i=e.hasOwnProperty(s);return e.constructor.createProperty(s,t),i?Object.getOwnPropertyDescriptor(e,s):void 0})(t,e,s)}const pt=new URL("Alien-Encounters-Regular.ttf".toLowerCase(),import.meta.url).toString(),ut=new URL("Alien-Encounters-Bold.ttf".toLowerCase(),import.meta.url).toString(),ft=new URL("base-layer.png",import.meta.url).toString(),mt="bitcoin-miner-card-fonts";let $t=class extends at{connectedCallback(){super.connectedCallback(),function(){if("undefined"!=typeof document){if(!document.getElementById(mt)){const t=document.createElement("style");t.id=mt,t.textContent=`\n      @font-face {\n        font-family: "Bitcoin Miner Alien Local";\n        src: url("${pt}") format("truetype");\n        font-weight: 400;\n        font-style: normal;\n        font-display: block;\n      }\n\n      @font-face {\n        font-family: "Bitcoin Miner Alien Local";\n        src: url("${ut}") format("truetype");\n        font-weight: 700;\n        font-style: normal;\n        font-display: block;\n      }\n    `,document.head.appendChild(t)}"fonts"in document&&(document.fonts.load('400 1em "Bitcoin Miner Alien Local"'),document.fonts.load('700 1em "Bitcoin Miner Alien Local"'))}}()}static getStubConfig(){return{}}static getConfigForm(){return{schema:[{name:"title_entity",selector:{entity:{}}},{name:"miner_name_entity",selector:{entity:{}}},{name:"hashrate_entity",selector:{entity:{}}},{name:"temperature_entity",selector:{entity:{}}},{name:"power_entity",selector:{entity:{}}},{name:"model_entity",selector:{entity:{}}}],computeLabel:t=>{switch(t.name){case"title_entity":return"Title Entity";case"miner_name_entity":return"IP Address";case"hashrate_entity":return"Hashrate Entity";case"temperature_entity":return"Temperature Entity";case"power_entity":return"Power Entity";case"model_entity":return"Model Entity";default:return}},computeHelper:t=>{switch(t.name){case"title_entity":return"Sensor used for the title line.";case"miner_name_entity":return"Sensor used for the IP address line.";default:return}}}}setConfig(t){if(!t)throw new Error("Invalid configuration for bitcoin-miner-card");this.config={overheat_threshold:85,...t}}getCardSize(){return 3}getGridOptions(){return{rows:5,columns:"full",min_rows:5,min_columns:12,max_columns:12}}render(){if(!this.config)return W;const t=this.readState(this.config.title_entity,""),e=this.normalizeForDisplay(t.value||""),s=this.readState(this.config.hashrate_entity,"MH/s"),i=this.readState(this.config.temperature_entity,"°C"),n=this.readState(this.config.power_entity,"W"),r=this.readState(this.config.model_entity,""),o=this.readState(this.config.miner_name_entity,""),a=this.normalizeForDisplay(o.value),l=this.config.overheat_threshold??85,h=this.parseNumericState(i.value),c=null!==h&&h>=l;return q`
  ...
  `,t([dt({attribute:!1})],$t.prototype,"hass",void 0),t([dt({attribute:!1})],$t.prototype,"config",void 0),$t=t([(t=>(e,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("bitcoin-miner-card")],$t),window.customCards=window.customCards||[],window.customCards.push({type:"bitcoin-miner-card",name:"Bitcoin Miner Card",preview:!1,description:"A custom card for monitoring Bitcoin miner stats.",documentationURL:"https://developers.home-assistant.io/docs/frontend/custom-ui/custom-card/"});export{$t as BitcoinMinerCard};

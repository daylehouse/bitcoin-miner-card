      ...
      <ha-card>
        <section class="stage" style=${`--bm-base-image: url('${h}')`}>
          ...
          <div class="device-values">
            <span class="stat-value value-fire"><span class="label label-cyan">Miner</span><span class="colon">:</span><span class="val val-pink">${n}</span></span>
            <span class="stat-value value-gamma"><span class="label label-lavender">Model</span><span class="colon">:</span><span class="val val-pink">${r.value}</span></span>
            <span class="stat-value value-temp"><span class="label label-lavender">Temp</span><span class="colon">:</span><span class="val ${l?"val-danger":"val-amber"}">${this.formatState(s)}</span></span>
            <span class="stat-value value-power"><span class="label label-cyan">Power</span><span class="colon">:</span><span class="val val-cyan">${this.formatState(i)}</span></span>
          </div>
        </section>
      </ha-card>

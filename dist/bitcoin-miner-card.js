      ...
      <ha-card .header=${this.config.title}>
        <section class="stage" style=${h}>
          ...
          <div class="device-values">
            <span class="stat-value value-fire">${r}</span>
            <span class="stat-value value-gamma">${i.value}</span>
            <span class=${`${a} value-temp`}>${this.formatState(e)}</span>
            <span class="stat-value accent-cyan value-power">${this.formatState(s)}</span>
          </div>
        </section>
      </ha-card>

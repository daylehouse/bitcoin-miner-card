      ...
      <ha-card .header=${t}>
        <section class="stage" style=${`--bm-base-image: url('${l}')`}>
          ...
          <div class="device-values">
            <span class="stat-value value-fire">${n}</span>
            <span class="stat-value value-gamma">${r.value}</span>
            <span class=${`${h} value-temp`}>${this.formatState(s)}</span>
            <span class="stat-value accent-cyan value-power">${this.formatState(i)}</span>
          </div>
        </section>
      </ha-card>
